...
from models.NaturalMatch.naturalmatch import NaturalMatch
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = NaturalMatch(_net_builder,
                     args.num_classes,
                     args.ema_m,
                     args.ulb_loss_ratio,
                     args.ent_loss_ratio,
    ...
    ## set SGD and cosine lr on NaturalMatch
    ...
    if args.dataset != "imagenet":
        ...
        train_dset = SSL_Dataset(args, alg='naturalmatch', name=args.dataset, train=True,
                                num_classes=args.num_classes, data_dir=args.data_dir)
        lb_dset, ulb_dset = train_dset.get_ssl_dset(args.num_labels)

        _eval_dset = SSL_Dataset(args, alg='naturalmatch', name=args.dataset, train=False,
                                num_classes=args.num_classes, data_dir=args.data_dir)
    ...
    ## set DataLoader on NaturalMatch
    ...
    # START TRAINING of NaturalMatch
    trainer = model.train
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='naturalmatch')
    ...
    '''
    Training Configuration of NaturalMatch
    '''
